 ...
 * @returns - Route pour la création d'un compte utilisateur en vérifiant les données entrées, 
 *            l'unicité de l'email, 
 *            et en retournant un token JWT ainsi que les informations de l'utilisateur créé.
 ...
 * @param  {Request} req - Requête entrante
 * @param {Response} res - Réponse sortante
 * @returns - Route pour la connexion d'un utilisateur en vérifiant les données entrées, l'existence de l'utilisateur, la validité du mot de passe, et en retournant un token JWT ainsi que les informations de l'utilisateur connecté.
 * @throws - 400 si les données sont manquantes, 
 *           401 si l'utilisateur est inconnu ou si le mot de passe est incorrect, 
 *           500 en cas d'erreur serveur.
 * 
 */
